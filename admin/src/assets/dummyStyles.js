...
export const doctorDetailStyles = {
  ...
  // File upload styles
  fileInput: "w-44 md:w-[190px] border-2 border-emerald-300 rounded-full px-2 py-1.5 text-sm bg-white text-emerald-700 file:mr-2 file:px-3 file:py-1 file:rounded-full file:border-0 file:bg-emerald-50 file:text-emerald-700 hover:border-emerald-400 focus:outline-none focus:border-emerald-400 transition",
  imagePreview: "h-12 w-12 md:h-16 md:w-16 rounded-full shadow-md border-2 border-emerald-200 object-cover",
  removeImageButton: "absolute -top-1 -right-1 bg-rose-500 hover:bg-rose-600 text-white rounded-full w-5 h-5 flex items-center justify-center shadow transition",
...
export const addServiceStyles = {
  ...
  toast: {
    ...
    toastError: "bg-white border-red-200",
    toastInfo: "bg-white border-blue-200",
    toastSuccess: "bg-white border-emerald-200",
    iconContainer: (type) => {
      const styles = {
...
export const doctorListStyles = {
  ...
  gridContainer: "max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 items-start",
  
  article: "bg-linear-to-r from-emerald-100/50 to-white rounded-2xl shadow-md border border-emerald-100 overflow-hidden transition-all duration-300 min-h-[170px]",
  articleContent: "flex flex-col sm:flex-row items-start sm:items-center gap-4 p-3 sm:p-4 md:p-5",
  
  doctorImage: "w-20 h-20 rounded-xl object-cover object-center border border-emerald-200 shadow-sm mx-auto sm:mx-0 shrink-0",
...
export const heroStyles = {
  ...
  mainContainer: "flex items-center justify-center px-4 sm:px-6 py-12 md:py-16 lg:py-20",
  ...
  // Content container
  contentBox: "bg-white/90 backdrop-blur-sm border border-emerald-100 rounded-3xl shadow-xl p-6 sm:p-8 md:p-12 text-center",
  
  // Logo/Image styles
  logoContainer: "mx-auto mb-4 w-20 h-20 md:w-24 md:h-24 flex items-center justify-center",
  logo: "w-full h-full object-contain",
  
  // Text styles
  heading: "text-2xl sm:text-3xl md:text-4xl font-extrabold text-emerald-900 mb-3",
  description: "text-sm sm:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8",
  
  // Info cards styles
  infoCards: {
    container: "mx-auto max-w-4xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6",
    card: "p-5 md:p-6 rounded-xl bg-linear-to-br from-emerald-50 to-emerald-40 border border-emerald-200 text-left shadow-sm hover:shadow-md transition transform hover:-translate-y-1",
    cardTitle: "font-semibold text-base md:text-lg text-emerald-800",
    cardText: "text-sm text-emerald-700 mt-2 leading-relaxed"
  }
};
...
export const serviceListStyles = {
  ...
  // Grid styles
  servicesGrid: "grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-6 items-start",
  
  // Service card styles
  serviceCard: "bg-white rounded-2xl overflow-hidden self-start h-fit transform transition hover:-translate-y-1 hover:shadow-2xl border border-emerald-50",
...
export const serviceAppointmentsStyles = {
  ...
  searchContainer: "w-full md:w-[34rem] flex flex-col gap-2",
  searchInputWrapper: "flex flex-col sm:flex-row items-stretch sm:items-center gap-3",
  searchLabel: "relative block w-full",
  searchIconContainer: "absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none",
  searchIcon: "w-4 h-4 text-emerald-400",
  searchInput: "pl-10 pr-10 w-full rounded-full border border-emerald-200 bg-white py-2.5 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 transition-all",
  clearSearchButton: "absolute right-3 rounded-full p-1 hover:bg-gray-100",
  clearSearchIcon: "w-4 h-4 text-gray-500",
  
  statusFilterSelect: "text-sm px-3 py-2.5 cursor-pointer rounded-full border border-emerald-400 min-w-[140px]",
  searchInfo: "mt-1 px-1 text-xs text-gray-500 flex items-center justify-between",
