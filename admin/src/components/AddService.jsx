...
const AddService = ({ serviceId }) => {
  ...
  }, [slotMonth, slotYear, slotDay, daysInSelectedMonth]);
        ...
        <div className={addServiceStyles.toast.container}>
          {toast && (
            <div>
              ...
              >
                <div
                  className={addServiceStyles.toast.iconContainer(toast.type)}
                >
                  {toast.type === "error" ? (
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-200 rounded-b-2xl overflow-hidden">
                  <div
                    ...
                    style={{
                      width: toastPhase === "visible" ? "0%" : "100%",
                      transition:
                        toastPhase === "visible"
              ...
              <div className={addServiceStyles.slots.container(errors.slots)}>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2 text-emerald-700 font-medium">
                    <CalendarDays className="w-5 h-5" /> Slots & Schedule
                  </div>
                  ...
                  <div className={addServiceStyles.grids.slotsGrid}>
                    {slots.length === 0 ? (
                      <div className="text-sm text-gray-400 italic px-4 py-2">
                        No slots added yet. Select a time and click "Add This
                        Time Slot"
                      </div>
                    ) : (
                      slots.map((s, idx) => (
