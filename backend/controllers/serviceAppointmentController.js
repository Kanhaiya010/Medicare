...
export const createServiceAppointment = async (req, res) => {
  try {
    ...
    const successUrl = `${frontendBase}/service-appointment/success?session_id={CHECKOUT_SESSION_ID}&return_to=${encodedReturnTo}`;
    const cancelUrl = `${frontendBase}/service-appointment/cancel?return_to=${encodedReturnTo}`;
