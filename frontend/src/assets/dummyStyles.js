...
export const doctorsPageStyles = {
  ...
  customCSS: `
    .dp-glow-btn {
      ...
      animation: dpPulseGlow 2.1s ease-in-out infinite;
    }
    .dp-glow-btn::after {
      content: "";
      position: absolute;
    ...
    .dp-exp-glow {
      box-shadow: 0 0 0 rgba(16,185,129,0);
      animation: dpExpGlowPulse 2s ease-in-out infinite;
    }

    @keyframes dpPulseGlow {
      0%, 100% { box-shadow: 0 0 0 rgba(16,185,129,0); }
      50% { box-shadow: 0 0 24px rgba(16,185,129,0.42); }
    }

    @keyframes dpExpGlowPulse {
      0%, 100% {
        box-shadow: 0 0 0 rgba(16,185,129,0);
      }
      50% {
...
export const footerStyles = {
  ...
  trustBadges: "flex flex-wrap gap-2 justify-center lg:justify-start mb-5",
  trustBadge:
    "px-3 py-1 rounded-full text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 shadow-sm",
...
export const homeDoctorsStyles = {
  // Section container
  section:
    "relative overflow-hidden py-12 bg-linear-to-br from-emerald-50 via-white to-cyan-50",
  container: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",

  // Header
  header: "text-center mb-10",
  title:
    "text-4xl md:text-5xl font-serif italic text-gray-900 tracking-tight drop-shadow-[0_4px_12px_rgba(16,185,129,0.16)]",
  titleSpan: "text-emerald-600 font-semibold",
  subtitle: "mt-2 text-gray-600 max-w-2xl mx-auto leading-relaxed",

  // Error/Retry
  errorContainer: "text-center mb-6",
  errorText: "text-sm text-rose-600 mb-2",
  retryButton:
    "px-5 py-2 rounded-full bg-linear-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-200 transition hover:shadow-emerald-300",

  // Loading skeleton
  skeletonGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8",
  skeletonCard:
    "animate-pulse bg-white/90 backdrop-blur-sm rounded-3xl border border-emerald-100 shadow-md p-4 h-72",
  skeletonImage: "bg-emerald-100 rounded-2xl h-40 mb-4",
  ...
  // Doctor card
  article:
    "group relative bg-white/85 backdrop-blur-md rounded-3xl border border-emerald-100 shadow-md hover:shadow-2xl hover:shadow-emerald-200/70 hover:-translate-y-1 transition transform duration-300 overflow-hidden",
  ...
  image:
    "w-full h-full object-cover object-center transform transition-transform duration-700 group-hover:scale-[1.06]",
  unavailableBadge:
  ...
  doctorName:
    "text-base sm:text-lg md:text-sm lg:text-md xl:text-xl font-semibold text-slate-900",
  specialization:
    "text-sm sm:text-sm md:text-sm text-emerald-700 font-medium mt-1",

  // Experience badge
  experienceContainer:
    "mt-3 flex items-center justify-between text-sm text-gray-600",
  experienceBadge:
    "flex items-center gap-2 border border-emerald-300 bg-linear-to-r from-emerald-50 to-teal-50 px-3 py-1 rounded-full text-xs sm:text-sm shadow-sm",

  // Buttons
  buttonContainer: "mt-3",
  buttonAvailable:
    "w-full inline-flex items-center justify-center gap-2 py-2.5 sm:py-3 rounded-full font-semibold transition-all duration-300 text-sm bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white hover:-translate-y-0.5 hover:brightness-110 shadow-lg shadow-emerald-200/70",
  buttonUnavailable:
    "w-full inline-flex items-center justify-center gap-2 py-2.5 sm:py-3 rounded-full font-medium bg-gray-200 text-gray-500 cursor-not-allowed text-sm",

  // Custom CSS
  customCSS: `
    .shadow-md { box-shadow: 0 8px 20px rgba(8, 35, 48, 0.08); }
    .shadow-2xl { box-shadow: 0 22px 55px rgba(6, 37, 45, 0.14); }
    ...
    .hd-bg-orb-1 {
      ...
      top: -4rem;
      left: -3rem;
      background: radial-gradient(circle, rgba(16,185,129,0.55), rgba(16,185,129,0));
    ...
    .hd-card-reveal {
      opacity: 0;
      animation: hdReveal 520ms ease-out forwards;
    }
    ...
    .hd-glow-btn {
      ...
      overflow: hidden;
      box-shadow: 0 0 0 rgba(16,185,129,0);
      animation: hdPulseGlow 2.1s ease-in-out infinite;
    }
    .hd-glow-btn::after {
      content: "";
      position: absolute;
    ...
    .hd-exp-glow {
      box-shadow: 0 0 0 rgba(16,185,129,0);
      animation: hdExpGlowPulse 2s ease-in-out infinite;
    }
...
export const navbarStyles = {
  ...
  // Desktop navigation
  desktopNav: "hidden lg:flex flex-1 min-w-0 items-center justify-center px-2",
  navItemsContainer:
    "flex flex-col items-center gap-1 bg-white border border-emerald-200 p-1 rounded-2xl shadow-lg lg:flex-row lg:rounded-full",
  navItem:
    "nav-item px-3 lg:px-4 py-2 rounded-full text-xs lg:text-sm font-semibold whitespace-nowrap transition-all duration-300",
...
export const testimonialStyles = {
  // Main container
  container:
    "min-h-[70vh] bg-linear-to-br from-slate-50 via-cyan-50/50 to-emerald-50 py-10 px-4 relative overflow-hidden",

  // Header
  headerContainer: "relative z-10 max-w-6xl font-serif mx-auto text-center mb-8 sm:mb-12",
  title:
    "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-linear-to-br from-sky-700 via-cyan-600 to-emerald-600 mb-3 drop-shadow-[0_8px_24px_rgba(14,165,233,0.2)]",
  subtitle: "text-sm sm:text-base text-slate-600 max-w-3xl mx-auto leading-relaxed",

  // Testimonial grid
  grid: "relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-5xl mx-auto items-stretch",

  // Column container
  columnContainer:
    "relative font-serif border rounded-3xl overflow-hidden bg-white/70 backdrop-blur-md shadow-[0_12px_34px_rgba(2,6,23,0.08)]",
  leftColumnBorder: "border-sky-200",
  rightColumnBorder: "border-emerald-200",

  // Column header
  columnHeader:
    "py-3 px-4 font-semibold text-sm sm:text-base text-center border-b",
  columnHeaderInner: "inline-flex items-center gap-2",
  leftColumnHeader: "bg-linear-to-r from-sky-100 to-cyan-50 text-sky-700 border-sky-200",
  rightColumnHeader:
    "bg-linear-to-r from-emerald-100 to-teal-50 text-emerald-700 border-emerald-200",
  ...
  // Testimonial card
  testimonialCard:
    "bg-white/95 rounded-2xl shadow-md p-4 sm:p-5 mb-4 transition-all duration-300 border w-full max-w-xl mx-auto hover:-translate-y-0.5 hover:shadow-xl",
  leftCardBorder: "border-sky-200 hover:shadow-sky-100/80",
  rightCardBorder: "border-emerald-200 hover:shadow-emerald-100/80",

  // Card content
  cardContent: "flex items-start space-x-3 sm:space-x-4",
  avatar:
    "w-12 h-12 sm:w-14 sm:h-14 object-cover rounded-full border-2 border-white shadow-md ring-2 ring-slate-100",
  textContainer: "flex-1",
  nameRoleContainer: "flex items-center justify-between gap-3",
  name: "font-semibold text-sm sm:text-base",
  leftName: "text-sky-900",
  rightName: "text-emerald-900",
  role: "text-xs sm:text-sm text-slate-500",
  quote: "text-slate-700 italic text-sm sm:text-base mt-2 leading-relaxed",
  ...
  animationStyles: `
    ...
    .ts-orb-left {
      top: -5rem;
      left: -4rem;
      background: radial-gradient(circle, rgba(56,189,248,0.65), rgba(56,189,248,0));
      animation: tsFloat 9s ease-in-out infinite;
    }
    .ts-orb-right {
      right: -5rem;
      bottom: -6rem;
      background: radial-gradient(circle, rgba(16,185,129,0.6), rgba(16,185,129,0));
      animation: tsFloat 11s ease-in-out infinite reverse;
    }
