...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/6207249536?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Jharkhand, Ranchi, Dhurwa, 834004
            </p>

            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 6207249536
            </p>

            <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> kanhaiya49536@gmail.com
            </p>
          </div>

          <iframe
            src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d445.4947300279322!2d85.29313669812694!3d23.32312893795778!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sdhurwa%20sec%201%20panchmukhi%20hanuman%20mandir!5e0!3m2!1sen!2sin!4v1772917971696!5m2!1sen!2sin"
            width="100%"
            height="400"
            style={{ border: 0, borderRadius: "20px" }}
            title="Panchmukhi Hanuman Mandir "
            loading="lazy"
            allowFullScreen
