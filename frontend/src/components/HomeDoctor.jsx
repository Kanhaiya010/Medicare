...
const HomeDoctors = ({ previewCount = 8 }) => {
  ...
  // to fetch doctors from the serv
  useEffect(() => {
    let mounted = true;
    async function load() {
      setLoading(true);
  ...
  return (
    <section className={homeDoctorsStyles.section}>
      <div className="hd-bg-orb hd-bg-orb-1"></div>
      <div className="hd-bg-orb hd-bg-orb-2"></div>
          ...
          <div className={homeDoctorsStyles.doctorsGrid}>
            {preview.map((doctor, index) => (
              <article
                ...
                className={`${homeDoctorsStyles.article} hd-card-reveal`}
              ...
              >
                ...
                <div className={homeDoctorsStyles.cardBody}>
                  ...
                  <div className={homeDoctorsStyles.experienceContainer}>
                    <div className={`${homeDoctorsStyles.experienceBadge} hd-exp-glow`}>
                    ...
                    <div className="w-full">
                      {doctor.available ? (
                        <Link
                          ...
                          className={`${homeDoctorsStyles.buttonAvailable} hd-glow-btn`}
                        >
                        ...
                        <button
                          disabled
                          className={`${homeDoctorsStyles.buttonUnavailable} hd-disabled-btn`}
                        >
